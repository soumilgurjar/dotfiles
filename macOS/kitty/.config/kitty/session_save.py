...
# startup_session ~/.config/kitty/sessions/session.conf
# allow_remote_control yes
# map kitty_mod+s launch ~/.config/kitty/session_save.sh
...
json_path = "sessions/kitty-session.json"
...
with open(sess_dump_path) as f:
    ...
    sess_file_path = "sessions/session.conf"
