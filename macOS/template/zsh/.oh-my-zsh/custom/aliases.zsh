...
function vidl() {
    nvim -d ~/Git_Repositories/dotfiles/macOS/template/$1 ~/Git_Repositories/dotfiles/linux/$1
}

function vid() {
    nvim -d ~/Git_Repositories/dotfiles/macOS/template/$1 ~/Git_Repositories/dotfiles/macOS/calderon/$1
}
...
# Stow related
function stow_adopt_test() { cd ~/Git_Repositories/dotfiles/macOS/template && stow --adopt -nvSt ~ $1 && cd - }
function stow_adopt() { cd ~/Git_Repositories/dotfiles/macOS/template && stow --adopt -vSt ~ $1 && cd - }
function stowth_test() { cd ~/Git_Repositories/dotfiles/macOS/template && stow -nvSt ~ $1 && cd - }
function stowth() { cd ~/Git_Repositories/dotfiles/macOS/template && stow -vSt ~ $1 && cd - }
function unstow_test() {  cd ~/Git_Repositories/dotfiles/macOS/template && stow -nvDt ~ $1 && cd - }
function unstow() {  cd ~/Git_Repositories/dotfiles/macOS/template && stow -vDt ~ $1 && cd - }
