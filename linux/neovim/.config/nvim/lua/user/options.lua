...
vim.g.python3_host_prog = "/home/soumilgurjar/.local/share/virtualenvs/py3nvim_env-NebPCnxv-python/bin/python" -- Python3 executable for neovim within a pyenv virtualenv
-- stylua: ignore end
