...
alias viw="nvim /mnt/g/My Drive/Apps/vimwiki/index.md"

function vidl() {
    nvim -d ~/Git_Repositories/dotfiles/linux/simrekarch/$1 ~/Git_Repositories/dotfiles/linux/wsl/$1
}

function vida() {
    nvim -d ~/Git_Repositories/dotfiles/linux/simrekarch/$1 ~/Git_Repositories/dotfiles/linux/ayrton/$1
}

function vid() {
    nvim -d ~/Git_Repositories/dotfiles/linux/simrekarch/$1 ~/Git_Repositories/dotfiles/macOS/noether/$1
}
...
# Stow related
function stow_adopt_test() { cd ~/Git_Repositories/dotfiles/linux/simrekarch && stow --adopt -nvSt ~ $1 && cd - }
function stow_adopt() { cd ~/Git_Repositories/dotfiles/linux/simrekarch && stow --adopt -vSt ~ $1 && cd - }
function stowth_test() { cd ~/Git_Repositories/dotfiles/linux/simrekarch && stow -nvSt ~ $1 && cd - }
function stowth() { cd ~/Git_Repositories/dotfiles/linux/simrekarch && stow -vSt ~ $1 && cd - }
function unstow_test() { cd ~/Git_Repositories/dotfiles/linux/simrekarch && stow -nvDt ~ $1 && cd - }
function unstow() { cd ~/Git_Repositories/dotfiles/linux/simrekarch && stow -vDt ~ $1 && cd - }

#Commonly accessed directories
alias win="cd /mnt/c/Users/Soumil - Simreka/"
