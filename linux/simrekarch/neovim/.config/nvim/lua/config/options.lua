...
vim.g.python3_host_prog = "/home/soumilgurjar/.local/share/virtualenvs/pynvim-kWHDhcTl-python/bin/python" -- Python3 executable for neovim within a pipenv virtualenv
-- stylua: ignore end
