...
# module load new gcc/4.8.2 qt/4.8.4 python/2.7.6 open_mpi/1.6.5 openfoam/2.4.0 matlab/R2020a mesa/12.0.6 tmux/2.5
# module load new gcc/4.8.2 qt/4.8.4 python/3.6.0 open_mpi/1.6.5 openfoam/2.4.0 matlab/R2020a mesa/12.0.6 tmux/2.5
...
# module load gcc/8.2.0 openmpi/3.0.1     # Load modules
# module load python/3.10.4
# module load openfoam-com/1806 paraview/5.9.1 gmsh/4.4.1 matlab/R2022a
# module load vim/8.2.1201 tmux/3.2a curl/7.73.0 git/2.31.1 cmake/3.25.0
